...
function Footer() {
  ...
  return (
    <footer className={`${theme ? "bg-slate-800 text-white" : "bg-lightmodeheader text-gray-800"}  py-10 px-4 sm:px-6 md:px-8`}>
      <div className='max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-6 sm:space-y-0'>
        <div className='space-y-4'>
          ...
          <div className='flex items-center space-x-2'>
            <Mail size={20} />
            <a href="mailto:baronhw808@gmail.com" className='hover:text-blue-400 transition-colors'>baronhw808@gmail.com</a>
          </div>
        </div>
        <div className='space-y-4'>
          <h3 className='text-xl font-semibold'>Connect</h3>
          <div className={`flex items-center justify-center space-x-2 ${theme ? "bg-slate-700 " : "bg-lightmodeloginbutton"} rounded-full px-4 py-2  transition-colors`}>
            <Instagram size={20} />
